...
public static class TableCatalog
{
    ...
    [
        ...
        Def(TableId.AuthorEx, "Связь: автор — экспонат", AdminFull),
        Def(TableId.ExhibitionExhibits, "Связь: выставка — экспонат", AdminFull),
        Def(TableId.ExhibitionHalls, "Связь: выставка — зал", AdminFull),
        Def(TableId.ExhibitMaterials, "Связь: экспонат — материал", AdminFull),
